...
debt11.act('SET_REMINDER 24.06.2025-15:00:00 Мне будет 38 лет', official=True)
time.sleep(1)
...
time.sleep(1)
debt21.act('SET_REMINDER 17.04.2025-15:15:15 Тестовое нопоминание', official=True)
time.sleep(1)
debt2.act('SET_REMINDER 18.04.2025-15:15:15 Тестовое нопоминание', official=True)
